...
public class MessageUser {
    public static final String TOKENBOT = "6993230113:AAFsj_ytf_5VOfcdwCvGx7vLrbrHQ2eF7YE";
    public static final String BOTNAME = "@SmokeBuyBot";
    public static final String STARTMESSAGEUSER = "Привіт! \uD83D\uDC4B Вітаємо вас у SmokeBot – вашому надійному помічнику для купівлі якісної жижки для електронних сигарет! \uD83D\uDCA8\n" +
            "\n" +
    ...
    public static final String ADMINID = "123213";

    public static final String CONTACT = "\uD83D\uDCDE Контакти\n" +
            "\n" +
